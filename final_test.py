...
# - The date is January 27.
# - January 27 is on a Tuesday.
# - The year I'm looking for is not the youngest year, but the second.

if __name__ == "__main__":
    # Replace the exit line with your function calls.
    exit()
