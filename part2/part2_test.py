...
# Bonus: what does this if-then statement check for? What could it possibly do?
# REPLACE THIS TEXT WITH YOUR BONUS ANSWER
if __name__ == "__main__":
    # Replace the exit line with your function call
    exit()